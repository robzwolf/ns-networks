# number_converter.py contains methods to convert a number to a short int / 32-bit int string and back again


def encode_to_short_int(number):
    """
...
def decode_from_short_int(string):
    """
...
def encode_to_32_int(number):
    """
    Takes a number in the range
    :param number:
    :return:
    """